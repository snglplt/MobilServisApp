...
class GelenReddedilenFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_gelen_reddedilen, container, false)
    ...
    private fun onFaturaGetir() {
        ...
        var url = "https://pratikhasar.com/netting/e_gelen_red_listesi.php?" + urlsb
        Log.d("RESİMYOL",url)
        ...
        val request = JsonObjectRequest(
            ...
            { response ->
                try{
                    val json = response["rededilen_faturalar"] as JSONArray
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                when (direction) {
                    ItemTouchHelper.RIGHT -> {
                        ...
                        builder.setTitle(getString(R.string.fatura_rededilmistir))
