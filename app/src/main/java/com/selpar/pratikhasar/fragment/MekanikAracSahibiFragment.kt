 ...
 * Use the [MekanikAracSahibiFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class MekanikAracSahibiFragment : Fragment()  {
    var marka = ""
    var model = ""
    var modelvers = ""
    var modelyili = ""
    ...
    lateinit var vergidairesi: EditText
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_mekanik_arac_sahibi, container, false)
        ...
        vergidairesi=view.findViewById<EditText>(R.id.etVergidairesi)
        ...
        val request = JsonObjectRequest(
            ...
            { response ->
                ...
                if(item.getString("vergidairesi").toString()!="null")
                    vergidairesi.setText(item.getString("vergidairesi").toString())
    ...
    private fun guncelleme_yapti(){
        ...
        object : StringRequest(
            ...
            override fun getParams(): Map<String, String>? {
                ...
                params["vergidairesi"]=vergidairesi.getText().toString()
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            MekanikAracSahibiFragment().apply {
