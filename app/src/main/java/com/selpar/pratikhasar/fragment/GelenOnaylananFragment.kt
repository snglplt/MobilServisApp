...
class GelenOnaylananFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_gelen_onaylanan, container, false)
        rc_gonderilmis_faturalar=view.findViewById(R.id.rc_gonderilmis_faturalar)
    ...
    private fun onFaturaGetir() {
        ...
        var url = "https://pratikhasar.com/netting/e_giden_listesi.php?" + urlsb
        Log.d("RESİMYOL",url)
        ...
        val request = JsonObjectRequest(
            ...
            { response ->
                try{
                    ...
                    val adapter =
                        ReddedilenFaturaAdapter(itemList)

                    rc_gonderilmis_faturalar.adapter= adapter
                    rc_gonderilmis_faturalar.layoutManager= LinearLayoutManager(requireContext())
                    rc_gonderilmis_faturalar.setHasFixedSize(false)
                ...
                Toast.makeText(requireContext(), "GETİRME BAŞARISIZ $error", Toast.LENGTH_SHORT).show()
            }
        )
        ...
        val simpleCallback = object :
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                when (direction) {
                    ItemTouchHelper.RIGHT -> {
                        val txt_faturaid = viewHolder.itemView.findViewById<TextView>(com.selpar.pratikhasar.R.id.txt_fatura_id)
                        val txt_id = viewHolder.itemView.findViewById<TextView>(com.selpar.pratikhasar.R.id.txt_id)
        ...
        itemTouchHelper.attachToRecyclerView(rc_gonderilmis_faturalar)
    ...
    private fun onPdfGoster(id: String, fatura_id: String) {
        ...
        i.putExtra("path","https://pratikhasar.com/netting/e_giden_pdf.php?firma_id="+firma_id+"&InvoiceUUID="+id+"&id="+fatura_id)
        startActivity(i)
