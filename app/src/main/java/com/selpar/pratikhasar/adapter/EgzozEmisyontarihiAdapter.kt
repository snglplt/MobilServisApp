...
class EgzozEmisyontarihiAdapter(private val newsList : ArrayList<news>) :
    RecyclerView.Adapter<EgzozEmisyontarihiAdapter.MyViewHolder>() {
        ...
        */}
        ...
        holder.image_view_whatsapp.setOnClickListener {
            ...
            if (imageUri != null) {
                ...
                intent.putExtra(Intent.EXTRA_TEXT, currentItem.plaka+" plakalı aracınızın egzoz emisyon bitiş tarihine  \n"+holder.txt_kalansure.getText().toString()+
...
//itemView.getContext().startActivity(intent)
    ...
    private fun kayitGetir(context: Context, firmaId: String, plaka: String) {
        ...
        var url = "https://pratikhasar.com/netting/mobil.php?tur=arama_kayit_bul_egzoz"+urlsb
    ...
    private fun onApi(context: Context, firma_id: String,plaka:String,tel:String, gorusme: String, aciklama: String,eknot:String) {
        ...
        val postRequest: StringRequest = object : StringRequest(
            ...
            override fun getParams(): Map<String, String>? {
                ...
                params["tur"] = "arama_detay_kaydet_egzoz"
                return params
            }
        }
