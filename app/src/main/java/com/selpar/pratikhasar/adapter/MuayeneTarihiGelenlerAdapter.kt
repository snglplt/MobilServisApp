...
class MuayeneTarihiGelenlerAdapter  (private val newsList : ArrayList<news>) :
    RecyclerView.Adapter<MuayeneTarihiGelenlerAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.image_view_whatsapp.setOnClickListener {
            ...
            if (imageUri != null) {
                ...
                intent.putExtra(Intent.EXTRA_TEXT, currentItem.plaka+" plakalı aracınızın muayene süresinin bitmesine \n"+holder.txt_kalansure.getText().toString()+
...
//itemView.getContext().startActivity(intent)
    ...
    private fun onAlert(context: Context, firmaId: String,plaka:String,tel:String) {
        ...
        alertadd.setView(view)
        alertadd.setPositiveButton(
            context.getString(R.string.ekle)
        ) { dialogInterface, which ->
    ...
    private fun onApi(context: Context, firma_id: String,plaka:String,tel:String, gorusme: String, aciklama: String,eknot:String) {
        ...
        val postRequest: StringRequest = object : StringRequest(
            ...
            override fun getParams(): Map<String, String>? {
                ...
                params["tur"] = "arama_detay_kaydet_muayene"
                return params
            }
        }
    ...
    private fun kayitGetir(context: Context, firmaId: String, plaka: String) {
        ...
        var url = "https://pratikhasar.com/netting/mobil.php?tur=arama_kayit_bul_muayene"+urlsb
