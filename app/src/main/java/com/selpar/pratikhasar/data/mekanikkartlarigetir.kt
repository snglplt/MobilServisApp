...
class mekanikkartlarigetir(private val newsList : ArrayList<news>) :
    RecyclerView.Adapter<mekanikkartlarigetir.MyViewHolder>() {
    lateinit var btnyazdir: Button
    ...
    class MyViewHolder(itemView : View) : RecyclerView.ViewHolder(itemView){
        ...
        val btnyazdir:Button=itemView.findViewById(R.id.btnHesaplaPdf)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): mekanikkartlarigetir.MyViewHolder {
        val itemView=
            LayoutInflater.from(parent.context).inflate(R.layout.card_kayitli_araclar,parent,false)

        return mekanikkartlarigetir.MyViewHolder(itemView)
    }

    @SuppressLint("SuspiciousIndentation")
    override fun onBindViewHolder(holder: mekanikkartlarigetir.MyViewHolder, position: Int) {
        ...
        if (currentItem.servis_turu == "Mekanik Servis") {
            //btnyazdir.setBackgroundColor(Color.GREEN)
        ...
        holder.itemView.setOnClickListener {
            val im = Intent(currentItem.context, MekanikKartBilgiActivity::class.java)
