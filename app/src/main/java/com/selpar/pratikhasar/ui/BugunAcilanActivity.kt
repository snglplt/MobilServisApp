...
class BugunAcilanActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_bugun_acilan)
        ...
        acikKartGetir()
        if(servis_hasar==0 && servis_mekanik==0){
            //Toast.makeText(this, getString(R.string.kayityok), Toast.LENGTH_SHORT).show()
        }
    ...
    private fun acikKartGetir() {
        ...
        var url = "https://pratikhasar.com/netting/mobil.php?tur=bugun_acilan_bul"+urlek
        val queue: RequestQueue = Volley.newRequestQueue(this)
        Log.d("onarim",url)
        val request = JsonObjectRequest(Request.Method.GET, url, null,
            { response ->try{
