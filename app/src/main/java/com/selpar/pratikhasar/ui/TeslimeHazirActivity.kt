...
class TeslimeHazirActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_teslime_hazir)
    ...
    { val i = Intent(this, TumAlanAramaActivity::class.java)
        ...
        i.putExtra("baslik", "Teslime Hazır")
    ...
    private fun acikKartGetir() {
        val urlek="&kadi="+kadi+"&sifre="+sifre+"&firma_id="+firma_id
        var url = "https://pratikhasar.com/netting/mobil.php?tur=teslime_hazir_araclar"+urlek
        val queue: RequestQueue = Volley.newRequestQueue(this)
        Log.d("onarim",url)
        val request = JsonObjectRequest(Request.Method.GET, url, null,
            { response ->try{
